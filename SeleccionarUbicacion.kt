package com.example.aplicacionroomrent
...
import com.example.aplicacionroomrent.databinding.ActivitySeleccionarUbicacionBinding
...
class SeleccionarUbicacion : AppCompatActivity() , OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.IbGps.setOnClickListener{
            if(esGpsActivado()){
                ...
                Toast.makeText(this,"!La ubicacion no esta activada¡. Activalo para mostrar la ubicacion actual",Toast.LENGTH_SHORT).show()
    ...
    private fun direccionLatLng(latlng: LatLng) {
        ...
        val gepCoder = Geocoder(this)
        try {
            val addressList = gepCoder.getFromLocation(latlng.latitude,latlng.longitude,1)
